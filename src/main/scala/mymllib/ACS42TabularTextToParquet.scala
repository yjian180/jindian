...
object ACS42TabularTextToParquet {
  //output Parquet is DataFrame in essence

  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setAppName("ACS43TabularTextToParquet").setMaster("local[2]")
    ...
    val struct =
      StructType(
        StructField("Continent", StringType, true) ::
          ...
          StructField("Hx_CHF", StringType, true) :: //has null
          StructField("CKD", StringType, true) :: //has null  y
          ...
          StructField("UA", DoubleType, true) ::
          StructField("Killip2", StringType, true) :: //y
          StructField("LVEF", DoubleType, true) :: //has null,  左室射血分数,度量(S) 2593 null in 9430 (6837 rest); (111:1 , 2481:0) in the null
          StructField("Hb_Admission", DoubleType, true) ::
          //          StructField("Hb_Discharge", DoubleType, true) :: //has null, 出院时血红蛋白,度量(S)
          ...
          StructField("Revasc_Complete", StringType, true) :: //y
          ...
          StructField("Clopi", DoubleType, true) ::
          StructField("Tica", DoubleType, true) ::
          StructField("Prasu", DoubleType, true) ::
